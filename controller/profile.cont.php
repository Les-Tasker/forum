...
if (isset($_GET['error'])) {
      ...
      <div class="profile-container-right">
        <div class="profile-bio">
          ...
          <form action="includes/editbio.inc.php" method="post" id="bio-form" class="hidden">
      ...
      <form id="upload-form-id" class="upload-form" action="includes/upload.inc.php" method="POST" enctype="multipart/form-data">
