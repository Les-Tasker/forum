...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <a class="navbar-brand border-left" href="index.php"><img id="logo-sae" src="./img/saenav.png"
                    alt="SAE Logo" /></a>
            <?php
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <div class="dropdown">
                    <button class="btn  dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><img class="header-user-img"
                            src="uploads/<?php echo $_SESSION['userImg'] ?>"></button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="#">
                            <form action="header.php" method="post">
                                <button class="logout-btn" type="submit" name="logout-submit">Logout<img
                                        src="img/logout.png"></button>
                            </form>
                        </a>
                    </div>
                </div>
        ...
        <form class="login-input" action="header.php" method="post">
