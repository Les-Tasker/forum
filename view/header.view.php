...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <a class="navbar-brand border-left" href="index.php"><img id="logo-sae" src="./img/saenav.png" alt="SAE Logo" /></a>
            <?php
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="inbox.php">
                                Inbox <img src="img/inbox.png"> <span class="unread"><?php $ShowUnread->Display_unread_message_Handler($_SESSION['userId']) ?></span>
                            </a>
