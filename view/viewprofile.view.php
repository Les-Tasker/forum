...
?>
            <div class="profile-container">
                <div class="profile-banner"><img src="uploads/<?php echo $usercover ?>" alt="">
                    <!-- <img id="cover-plus-icon" alt="Add new image" src="img/addimg.png" onclick="cover()" /> -->
                </div>
                <div class="profile-container-wrapper">

                    <form action="model/send-message.inc.php" method="post" id="send-message" class="hidden">
